...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM users WHERE username = 'admin') THEN
        INSERT INTO users (username, name, email, password, status, email_verified, is_active)
        VALUES ('admin', 'System Admin', 'admin@trbtree.com', '$2b$12$...hashed...', 'ACTIVE', true, true);
END IF;
END $$;
